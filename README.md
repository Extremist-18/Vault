...
1. **Frontend Layer:** Collects and encrypts expense data before sending it to the blockchain.  
2. **Smart Contract Layer:** Handles immutable storage and retrieval of expense transactions.  
3. **Blockchain Layer:** Provides decentralization and security using Ethereum’s framework.  
4. **Database Layer:** Stores encrypted off-chain data for performance and redundancy.
